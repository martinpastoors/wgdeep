...
datapath <- "D:/temp"
# datapath <- 
#   "//community.ices.dk@SSL/DavWWWRoot/ExpertGroups/WGWIDE/2019 Meeting docs/06. Data/_catch_by_rectangle"
...
plot_catch_by_year(myspecies="ARU", myyears = 1994:2018, ncol=5)
# plot_catch_by_year(myspecies="MAC", myyears = 1998:2018, ncol=5)

```

_Figure 1: Catch of mackerel (tonnes) by year and rectangle. Catch by rectangle data do not represent the official catches and cannot be used for management purposes. In general, the total annual catches by rectangle are within 10 % from the official catches._
...
plot_catch_by_year(myspecies="HOM", ncol=5)

```

_Figure 2: Catch of horse mackerel (tonnes) by year and rectangle. Catch by rectangle data do not represent the official catches and cannot be used for management purposes. In general, the total annual catches by rectangle are within 10 % from the official catches._
...
plot_catch_by_year(myspecies="WHB", ncol=5)

```

_Figure 3: Catch of blue whiting (tonnes) by year and rectangle. Catch by rectangle data do not represent the official catches and cannot be used for management purposes. In general, the total annual catches by rectangle are within 10 % from the official catches._
...
plot_catch_by_year(myspecies="HER", ncol=4)

```

_Figure 4: Catch of Atlanto-scandian herring (tonnes) by year and rectangle. Catch by rectangle data do not represent the official catches and cannot be used for management purposes. In general, the total annual catches by rectangle are within 10 % from the official catches._
